...
const AutomatedSearch = () => {
  ...
  const getPriceTagBadge = (tag) => {
    ...
    return (
      <Badge variant={variant} className={`capitalize text-xs ${className}`}>
        {tag}
      </Badge>
    );
  };
        ...
        <section className="py-20 relative overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 h-[550px] flex items-center lg:mt-0 inset-0 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-3xl p-6 ">
                <Card className="w-full border border-gray-200 shadow-lg">
                  <CardContent className="p-4">
                    <div>
                      <h1 className="text-2xl font-bold mb-4">
                        Your Recent Car Listings
                      </h1>
                    </div>
                    <Table>
                      <TableBody>
                        {carData.map((car) => {
                          ...
                          return (
                            <TableRow key={car.id}>
                              ...
                              <TableCell className="">
                                {getPriceTagBadge(car.price_tag)}
                              </TableCell>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our AI-powered search agent scans thousands of listings to find
                the perfect car at the right price
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Tell our AI what you're looking for - budget, make, model,
                  features, and any other requirements
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Our intelligent agent searches thousands of listings and
                  analyzes each one against your criteria
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Receive a curated list of vehicles that match your preferences
                  with price analysis and recommendations
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Get detailed insights on whether a car is priced fairly,
                      with market comparisons and historical data
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Just tell our AI what you want in conversational language
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Our AI learns from your feedback to provide increasingly
                      personalized car suggestions
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Get data-driven advice on how to negotiate the best
                      possible price for your chosen vehicle
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div>
                    <p className="text-lg text-gray-600 dark:text-gray-300 italic mb-6">
                      "Automated Search saved me countless hours of searching. I
                      told the AI exactly what I wanted, and within minutes it
                      found me three perfect matches. I ended up buying the
                      second car on the list and saved $3,200 because the AI
                      identified it was priced below market value."
                    </p>
                    <div>
