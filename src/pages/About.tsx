      ...
      <div className="pt-20 pb-16 md:pt-28 md:pb-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Transforming the car dealership industry through artificial
              intelligence
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                {COMPANY_NAME} was founded in 2025 with a simple mission: to
                bring the power of artificial intelligence to car dealerships of
                all sizes.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Today, we're proud to serve dealerships across the country,
                helping them leverage AI to increase sales, optimize operations,
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              To democratize access to AI technology in the automotive industry,
              enabling dealerships of all sizes to compete effectively in the
              digital age.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md animate-fade-in"
              style={{ animationDelay: "0.1s" }}
            >
              <h3 className="text-xl font-semibold mb-3 text-saas-blue">
                Innovation
              </h3>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We make advanced AI tools accessible to dealerships of all
                sizes, not just the large groups.
              </p>
            </div>
            <div
              className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md animate-fade-in"
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We measure our success by the tangible business impact we create
                for our customers.
              </p>
            </div>
          </div>
